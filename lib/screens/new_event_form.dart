...
import 'package:admin_panel_dashboard/model/events.dart';
...
class _FoodFormState extends State<FoodForm> {
 ...
 late List _subingredients = [];
 late Food _currentFood;
 late String _imageUrl;
 late File _imageFile;
  late TextEditingController subingredientController = new TextEditingController();
